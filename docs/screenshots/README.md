...
| `console-applications-diagnostics.png` | The **Applications** page with an unhealthy app — the **Diagnostics** view (DR-0005): the failing Crossplane condition inline under the app, plus a panel with the pod's `ImagePullBackOff`/crash cause and the tenant-plane fix hint. The console reading the conditions *with* you. |
