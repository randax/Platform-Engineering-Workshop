...
| In-cluster CI | **Argo Workflows** v4.1.1 + **BuildKit** v0.32.2 | Tekton · external/cloud CI | Rootless in-cluster image builds → your own Zot, no cloud minutes; Kaniko was archived June 2025. |
