...
This file is the maintainer-mode guide. The root CLAUDE.md / AGENTS.md /
.github/copilot-instructions.md are the attendee-facing tutor instructions
(merged just before the workshop); they point maintainers here.
