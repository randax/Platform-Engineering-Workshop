...
<div class="grid grid-cols-4 gap-3 mt-4">
  <div class="principle"><div class="ico">📦</div><div class="name">Platform as a product</div><div class="tie">built around user needs</div></div>
  <div class="principle"><div class="ico">✨</div><div class="name">User experience</div><div class="tie">consistent interfaces</div></div>
  <div class="principle"><div class="ico">📖</div><div class="name">Docs & onboarding</div><div class="tie">shipped with the platform</div></div>
  <div class="principle"><div class="ico">🛎️</div><div class="name">Self-service</div><div class="tie">no tickets, no humans</div></div>
  <div class="principle"><div class="ico">🧠</div><div class="name">Low cognitive load</div><div class="tie">intent, not implementation</div></div>
  <div class="principle"><div class="ico">🧩</div><div class="name">Optional & composable</div><div class="tie">use only what you need</div></div>
  <div class="principle"><div class="ico">🔒</div><div class="name">Secure by default</div><div class="tie">safe defaults, guardrails</div></div>
  <div class="principle"><div class="ico">☁️</div><div class="name">…on a laptop</div><div class="tie">the thinnest viable one</div></div>
</div>
...
<div class="grid grid-cols-2 gap-x-8 gap-y-2 mt-4 text-sm">
  <div>📦 <b>Product</b> → the Console — a front door you can read</div>
  <div>🧠 <b>Cognitive load</b> → <code>size: small</code>, not 12 DB fields</div>
  <div>✨ <b>UX</b> → one console over every capability</div>
  <div>🧩 <b>Composable</b> → enable from a catalog; kubectl still works</div>
  <div>📖 <b>Onboarding</b> → the labs, hints, locked-page teasers</div>
  <div>🔒 <b>Secure default</b> → "you hand the portal its keys" (RBAC)</div>
  <div>🛎️ <b>Self-service</b> → New Database / New Function forms</div>
  <div>☁️ <b>Thinnest viable</b> → all of it, on your laptop</div>
</div>
