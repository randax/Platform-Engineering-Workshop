...
- Golden path: nais.yaml's core idea, the manifest declares dependencies and not just the deployment, is precisely the Application XR of module 04/09. Say it explicitly: "you are building a build-your-own-Nais today."
...
Transition: "So that's the discipline. Here's the specific stack we'll do it with." Then the stack section.
-->
