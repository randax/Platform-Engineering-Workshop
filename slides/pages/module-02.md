...
<span class="badge">30 min</span> · behind? `./scripts/catch-up.sh 2`
...
From this point on catch-up.sh works for every module — it force-pushes canonical state to their Gitea. Anyone stuck at ~25 min: catch up, don't stall; the concepts land in 03–04 again.
-->
