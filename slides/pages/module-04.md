...
Lab flow: enable crossplane.yaml from the catalog, ship the two halves of the platform API (xrd.yaml, read the schema!, and composition.yaml) via git, confirm the XRD is ESTABLISHED, then switch hats and be the developer: push examples/my-database.yaml and watch the stack unfold.
-->
