...
<div class="grid grid-cols-1 gap-2 mt-2">
  <div v-click class="story"><span class="tag">0 · MARKED TRAIL</span> &nbsp;<Logo name="knative" size="1.2rem"/> <Logo name="argo-workflows" size="1.2rem"/> <Logo name="cloudbox" size="1.2rem"/> <Logo name="kagent" text="kagent" size="1.2rem"/> &nbsp;Modules 06–10, the guided finale — rehearsed, hinted, verified.</div>
...
- Door 0 is for "I want the curated ending" — modules 06 through 10, and it's excellent; fast finishers can walk it AND pick a door.
