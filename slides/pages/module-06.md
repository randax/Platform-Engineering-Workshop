...
<!--
The task: enable knative-serving.yaml from the catalog (Serving + Kourier, NodePort 31080), deliver hello-ksvc.yaml the GitOps way, by now nobody should need telling where it goes, then wait for READY True, then stage the moment:
